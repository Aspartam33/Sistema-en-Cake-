<nav class="navbar navbar-inverse nav-users">
    <div class="container">
        <div class="navbar-header">
	       ...
	       <?= $this->Html->link('EducationLinks', ['controller' => 'Users', 'action' => 'index'], ['class' => 'navbar-brand']) ?>
			<h4>Your favorite links, anywhere</h4>
			<h5>An initiative by EducationUSA<h5>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><?= $this->Html->link('Contacto', ['controller' => 'contacts', 'action' => 'add']) ?></li>
			  <li>
